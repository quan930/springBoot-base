...
public class BookCon {
    ...
    public Response getBook(@PathVariable Long id) {
        ...
        return bookDAO.findById(id).map(value -> new Response("successful", value,null)).orElseGet(() -> new Response("error", (Book) null,null));
    }
    ...
    public Response addBook(@RequestBody Book book){
        ...
        bookDAO.save(book);
        return new Response("successful",book,null);
    }
    ...
    public Response deleteBook(@PathVariable Long id) {
        ...
        if (book.isPresent()){
            ...
            return new Response("successful",book.get(),null);
        }else {
            return new Response("error", (List<Book>) null,null);
        }
    }
    ...
    public Response bookList(){
        ...
        return new Response("successful",bookDAO.findAll(),null);
    }
}
